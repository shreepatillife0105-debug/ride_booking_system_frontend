...
@Component({
  selector: 'app-seconddriver',
  templateUrl: './seconddriver.component.html',
  styleUrls: ['./seconddriver.component.css']
})
export class SeconddriverComponent implements OnInit, OnDestroy {
